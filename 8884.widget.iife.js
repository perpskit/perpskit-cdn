...
`;var f=function(t,e,o,i){var a,n=arguments.length,r=n<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,o,i);else for(var s=t.length-1;s>=0;s--)(a=t[s])&&(r=(n<3?a(r):n>3?a(e,o,r):a(e,o))||r);return n>3&&r&&Object.defineProperty(e,o,r),r};const m=v.oU.CONVERT_SLIPPAGE_TOLERANCE;let k=class extends i.WF{constructor(){super(),this.unsubscribe=[],this.networkName=c.W.state.activeCaipNetwork?.name,this.detailsOpen=!1,this.sourceToken=l.GN.state.sourceToken,this.toToken=l.GN.state.toToken,this.toTokenAmount=l.GN.state.toTokenAmount,this.sourceTokenPriceInUSD=l.GN.state.sourceTokenPriceInUSD,this.toTokenPriceInUSD=l.GN.state.toTokenPriceInUSD,this.priceImpact=l.GN.state.priceImpact,this.maxSlippage=l.GN.state.maxSlippage,this.networkTokenSymbol=l.GN.state.networkTokenSymbol,this.inputError=l.GN.state.inputError,this.unsubscribe.push(l.GN.subscribe(t=>{this.sourceToken=t.sourceToken,this.toToken=t.toToken,this.toTokenAmount=t.toTokenAmount,this.priceImpact=t.priceImpact,this.maxSlippage=t.maxSlippage,this.sourceTokenPriceInUSD=t.sourceTokenPriceInUSD,this.toTokenPriceInUSD=t.toTokenPriceInUSD,this.inputError=t.inputError}))}render(){const t=this.toTokenAmount&&this.maxSlippage?n.S.bigNumber(this.toTokenAmount).minus(this.maxSlippage).toString():null;if(!this.sourceToken||!this.toToken||this.inputError)return null;const e=this.sourceTokenPriceInUSD&&this.toTokenPriceInUSD?1/this.toTokenPriceInUSD*this.sourceTokenPriceInUSD:0;return i.qy`
    ...
    `}toggleDetails(){this.detailsOpen=!this.detailsOpen}};k.styles=[b],f([(0,a.wk)()],k.prototype,"networkName",void 0),f([(0,a.MZ)()],k.prototype,"detailsOpen",void 0),f([(0,a.wk)()],k.prototype,"sourceToken",void 0),f([(0,a.wk)()],k.prototype,"toToken",void 0),f([(0,a.wk)()],k.prototype,"toTokenAmount",void 0),f([(0,a.wk)()],k.prototype,"sourceTokenPriceInUSD",void 0),f([(0,a.wk)()],k.prototype,"toTokenPriceInUSD",void 0),f([(0,a.wk)()],k.prototype,"priceImpact",void 0),f([(0,a.wk)()],k.prototype,"maxSlippage",void 0),f([(0,a.wk)()],k.prototype,"networkTokenSymbol",void 0),f([(0,a.wk)()],k.prototype,"inputError",void 0),k=f([(0,g.EM)("w3m-swap-details")],k),o(50279);const y=i.AH`
  :host {
    width: 100%;
  }
