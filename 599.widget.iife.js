...
`;var c=function(t,e,o,r){var i,n=arguments.length,a=n<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,o,r);else for(var s=t.length-1;s>=0;s--)(i=t[s])&&(a=(n<3?i(a):n>3?i(e,o,a):i(e,o))||a);return n>3&&a&&Object.defineProperty(e,o,a),a};let l=class extends r.WF{constructor(){super(...arguments),this.color="accent-100",this.size="lg"}render(){return this.style.cssText="--local-color: "+("inherit"===this.color?"inherit":`var(--wui-color-${this.color})`),this.dataset.size=this.size,r.qy`<svg viewBox="25 25 50 50">
    ...
    </svg>`}};l.styles=[n.W5,s],c([(0,i.MZ)()],l.prototype,"color",void 0),c([(0,i.MZ)()],l.prototype,"size",void 0),l=c([(0,a.E)("wui-loading-spinner")],l)},20304:(t,e,o)=>{"use strict";var r=o(48422),i=o(91427),n=o(46358),a=o(31779);o(38273),o(66933),o(88766);const s=r.AH`
  :host > wui-flex {
...
`;var c=function(t,e,o,r){var i,n=arguments.length,a=n<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,o,r);else for(var s=t.length-1;s>=0;s--)(i=t[s])&&(a=(n<3?i(a):n>3?i(e,o,a):i(e,o))||a);return n>3&&a&&Object.defineProperty(e,o,a),a};let l=class extends r.WF{constructor(){super(),this.unsubscribe=[],this.remoteFeatures=n.H.state.remoteFeatures,this.unsubscribe.push(n.H.subscribeKey("remoteFeatures",t=>this.remoteFeatures=t))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){const{termsConditionsUrl:t,privacyPolicyUrl:e}=n.H.state,o=n.H.state.features?.legalCheckbox;return!t&&!e||o?r.qy`
    ...
    `}andTemplate(){const{termsConditionsUrl:t,privacyPolicyUrl:e}=n.H.state;return t&&e?"and":""}termsTemplate(){const{termsConditionsUrl:t}=n.H.state;return t?r.qy`<a href=${t} target="_blank" rel="noopener noreferrer"
      >Terms of Service</a
    >`:null}privacyTemplate(){const{privacyPolicyUrl:t}=n.H.state;return t?r.qy`<a href=${t} target="_blank" rel="noopener noreferrer"
      >Privacy Policy</a
    >`:null}reownBrandingTemplate(t=!1){return this.remoteFeatures?.reownBranding?t?r.qy`<wui-ux-by-reown class="branding-only"></wui-ux-by-reown>`:r.qy`<wui-ux-by-reown></wui-ux-by-reown>`:null}};l.styles=[s],c([(0,i.wk)()],l.prototype,"remoteFeatures",void 0),l=c([(0,a.EM)("w3m-legal-footer")],l)},23411:(t,e,o)=>{"use strict";o(30204)},23507:(t,e,o)=>{"use strict";o.d(e,{H:()=>n});var r=o(80971),i=o(39341);const n=(0,i.u$)(class extends i.WL{constructor(t){if(super(t),t.type!==i.OA.ATTRIBUTE||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t)));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const o=t.element.classList;for(const t of this.st)t in e||(o.remove(t),this.st.delete(t));for(const t in e){const r=!!e[t];r===this.st.has(t)||this.nt?.has(t)||(r?(o.add(t),this.st.add(t)):(o.remove(t),this.st.delete(t)))}return r.c0}})},24668:(t,e,o)=>{"use strict";var r=o(48422),i=o(91427),n=o(39168),a=(o(36858),o(47080)),s=o(39783);const c=r.AH`
  button {
...
`;var c=function(t,e,o,r){var i,n=arguments.length,a=n<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,o,r);else for(var s=t.length-1;s>=0;s--)(i=t[s])&&(a=(n<3?i(a):n>3?i(e,o,a):i(e,o))||a);return n>3&&a&&Object.defineProperty(e,o,a),a};let l=class extends r.WF{constructor(){super(...arguments),this.radius=36}render(){return this.svgLoaderTemplate()}svgLoaderTemplate(){const t=this.radius>50?50:this.radius,e=36-t,o=116+e,i=245+e,n=360+1.75*e;return r.qy`
    ...
    `}};l.styles=[n.W5,s],c([(0,i.MZ)({type:Number})],l.prototype,"radius",void 0),l=c([(0,a.E)("wui-loading-thumbnail")],l)},36858:(t,e,o)=>{"use strict";var r=o(48422),i=o(91427),n=o(23507),a=o(47080),s=o(39783);const c=r.AH`
  :host {
...
`;var g=function(t,e,o,r){var i,n=arguments.length,a=n<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,o,r);else for(var s=t.length-1;s>=0;s--)(i=t[s])&&(a=(n<3?i(a):n>3?i(e,o,a):i(e,o))||a);return n>3&&a&&Object.defineProperty(e,o,a),a};let p=class extends r.WF{constructor(){super(...arguments),this.inputElementRef=(0,l._)(),this.checked=void 0}render(){return r.qy`
    ...
    `}dispatchChangeEvent(){this.dispatchEvent(new CustomEvent("checkboxChange",{detail:this.inputElementRef.value?.checked,bubbles:!0,composed:!0}))}};p.styles=[u.W5,h],g([(0,i.MZ)({type:Boolean})],p.prototype,"checked",void 0),p=g([(0,d.E)("wui-checkbox")],p),o(66933);const f=r.AH`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
...
`;var v=function(t,e,o,r){var i,n=arguments.length,a=n<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,o,r);else for(var s=t.length-1;s>=0;s--)(i=t[s])&&(a=(n<3?i(a):n>3?i(e,o,a):i(e,o))||a);return n>3&&a&&Object.defineProperty(e,o,a),a};let b=class extends r.WF{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=l.a.state.connectors,this.authConnector=this.connectors.find(t=>"AUTH"===t.type),this.remoteFeatures=s.H.state.remoteFeatures,this.isPwaLoading=!1,this.unsubscribe.push(l.a.subscribeKey("connectors",t=>{this.connectors=t,this.authConnector=this.connectors.find(t=>"AUTH"===t.type)}),s.H.subscribeKey("remoteFeatures",t=>this.remoteFeatures=t))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){let t=this.remoteFeatures?.socials||[];const e=Boolean(this.authConnector),o=t?.length,i="ConnectSocials"===u.I.state.view;return e&&o||i?(i&&!o&&(t=d.oU.DEFAULT_SOCIALS),r.qy` <wui-flex flexDirection="column" gap="xs">
      ${t.map(t=>r.qy`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`):null}async onSocialClick(t){t&&await(0,g.Up)(t)}async handlePwaFrameLoad(){if(p.w.isPWA()){this.isPwaLoading=!0;try{this.authConnector?.provider instanceof f.Y&&await this.authConnector.provider.init()}catch(t){h.h.open({displayMessage:"Error loading embedded wallet in PWA",debugMessage:t.message},"error")}finally{this.isPwaLoading=!1}}}};b.styles=w,v([(0,i.MZ)()],b.prototype,"tabIdx",void 0),v([(0,i.wk)()],b.prototype,"connectors",void 0),v([(0,i.wk)()],b.prototype,"authConnector",void 0),v([(0,i.wk)()],b.prototype,"remoteFeatures",void 0),v([(0,i.wk)()],b.prototype,"isPwaLoading",void 0),b=v([(0,c.EM)("w3m-social-login-list")],b);const y=r.AH`
  wui-flex {
...
`;var m=function(t,e,o,r){var i,n=arguments.length,a=n<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,o,r);else for(var s=t.length-1;s>=0;s--)(i=t[s])&&(a=(n<3?i(a):n>3?i(e,o,a):i(e,o))||a);return n>3&&a&&Object.defineProperty(e,o,a),a};let x=class extends r.WF{constructor(){super(),this.unsubscribe=[],this.checked=a.o.state.isLegalCheckboxChecked,this.unsubscribe.push(a.o.subscribeKey("isLegalCheckboxChecked",t=>{this.checked=t}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){const{termsConditionsUrl:t,privacyPolicyUrl:e}=s.H.state,o=s.H.state.features?.legalCheckbox,i=Boolean(t||e)&&Boolean(o),a=i&&!this.checked,c=a?-1:void 0;return r.qy`
    ...
    `}};x.styles=y,m([(0,i.wk)()],x.prototype,"checked",void 0),x=m([(0,c.EM)("w3m-connect-socials-view")],x);var C=o(1759),k=o(68690),E=o(65149),$=o(58711),S=o(61401),P=o(23774),M=o(32757),R=o(77433),A=(o(23411),o(35404),o(41630),o(66933),o(30824)),T=o(42526);const I=r.AH`
  wui-logo {
    width: 80px;
    height: 80px;
...
`;var z=function(t,e,o,r){var i,n=arguments.length,a=n<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,o,r);else for(var s=t.length-1;s>=0;s--)(i=t[s])&&(a=(n<3?i(a):n>3?i(e,o,a):i(e,o))||a);return n>3&&a&&Object.defineProperty(e,o,a),a};let B=class extends r.WF{constructor(){super(),this.unsubscribe=[],this.socialProvider=C.U.state.socialProvider,this.socialWindow=C.U.state.socialWindow,this.error=!1,this.connecting=!1,this.message="Connect in the provider window",this.remoteFeatures=s.H.state.remoteFeatures,this.address=C.U.state.address,this.connectionsByNamespace=k.x.getConnections(E.W.state.activeChain),this.hasMultipleConnections=this.connectionsByNamespace.length>0,this.authConnector=l.a.getAuthConnector(),this.handleSocialConnection=async t=>{if(t.data?.resultUri)if(t.origin===T.o.SECURE_SITE_ORIGIN){window.removeEventListener("message",this.handleSocialConnection,!1);try{if(this.authConnector&&!this.connecting){this.socialWindow&&(this.socialWindow.close(),C.U.setSocialWindow(void 0,E.W.state.activeChain)),this.connecting=!0,this.updateMessage();const e=t.data.resultUri;this.socialProvider&&$.E.sendEvent({type:"track",event:"SOCIAL_LOGIN_REQUEST_USER_DATA",properties:{provider:this.socialProvider}}),await k.x.connectExternal({id:this.authConnector.id,type:this.authConnector.type,socialUri:e},this.authConnector.chain),this.socialProvider&&(S.i.setConnectedSocialProvider(this.socialProvider),$.E.sendEvent({type:"track",event:"SOCIAL_LOGIN_SUCCESS",properties:{provider:this.socialProvider,caipNetworkId:E.W.getActiveCaipNetwork()?.caipNetworkId}}))}}catch(t){this.error=!0,this.updateMessage(),this.socialProvider&&$.E.sendEvent({type:"track",event:"SOCIAL_LOGIN_ERROR",properties:{provider:this.socialProvider}})}}else u.I.goBack(),P.P.showError("Untrusted Origin"),this.socialProvider&&$.E.sendEvent({type:"track",event:"SOCIAL_LOGIN_ERROR",properties:{provider:this.socialProvider}})},A.R.EmbeddedWalletAbortController.signal.addEventListener("abort",()=>{this.socialWindow&&(this.socialWindow.close(),C.U.setSocialWindow(void 0,E.W.state.activeChain))}),this.unsubscribe.push(C.U.subscribe(t=>{t.socialProvider&&(this.socialProvider=t.socialProvider),t.socialWindow&&(this.socialWindow=t.socialWindow)}),s.H.subscribeKey("remoteFeatures",t=>{this.remoteFeatures=t}),C.U.subscribeKey("address",t=>{const e=this.remoteFeatures?.multiWallet;t&&t!==this.address&&(this.hasMultipleConnections&&e?(u.I.replace("ProfileWallets"),P.P.showSuccess("New Wallet Added")):(M.W.state.open||s.H.state.enableEmbedded)&&M.W.close())})),this.authConnector&&this.connectSocial()}disconnectedCallback(){this.unsubscribe.forEach(t=>t()),window.removeEventListener("message",this.handleSocialConnection,!1),this.socialWindow?.close(),C.U.setSocialWindow(void 0,E.W.state.activeChain)}render(){return r.qy`
    ...
    `}loaderTemplate(){const t=R.W.state.themeVariables["--w3m-border-radius-master"],e=t?parseInt(t.replace("px",""),10):4;return r.qy`<wui-loading-thumbnail radius=${9*e}></wui-loading-thumbnail>`}connectSocial(){const t=setInterval(()=>{this.socialWindow?.closed&&(this.connecting||"ConnectingSocial"!==u.I.state.view||(this.socialProvider&&$.E.sendEvent({type:"track",event:"SOCIAL_LOGIN_CANCELED",properties:{provider:this.socialProvider}}),u.I.goBack()),clearInterval(t))},1e3);window.addEventListener("message",this.handleSocialConnection,!1)}updateMessage(){this.error?this.message="Something went wrong":this.connecting?this.message="Retrieving user data":this.message="Connect in the provider window"}};B.styles=I,z([(0,i.wk)()],B.prototype,"socialProvider",void 0),z([(0,i.wk)()],B.prototype,"socialWindow",void 0),z([(0,i.wk)()],B.prototype,"error",void 0),z([(0,i.wk)()],B.prototype,"connecting",void 0),z([(0,i.wk)()],B.prototype,"message",void 0),z([(0,i.wk)()],B.prototype,"remoteFeatures",void 0),B=z([(0,c.EM)("w3m-connecting-social-view")],B),o(33846),o(90315),o(24668),o(83036),o(50279);const L=r.AH`
  @keyframes fadein {
    from {
      opacity: 0;
    }
...
`;var O=function(t,e,o,r){var i,n=arguments.length,a=n<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,o,r);else for(var s=t.length-1;s>=0;s--)(i=t[s])&&(a=(n<3?i(a):n>3?i(e,o,a):i(e,o))||a);return n>3&&a&&Object.defineProperty(e,o,a),a};let _=class extends r.WF{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.socialProvider=C.U.state.socialProvider,this.uri=C.U.state.farcasterUrl,this.ready=!1,this.loading=!1,this.remoteFeatures=s.H.state.remoteFeatures,this.authConnector=l.a.getAuthConnector(),this.forceUpdate=()=>{this.requestUpdate()},this.unsubscribe.push(C.U.subscribeKey("farcasterUrl",t=>{t&&(this.uri=t,this.connectFarcaster())}),C.U.subscribeKey("socialProvider",t=>{t&&(this.socialProvider=t)}),s.H.subscribeKey("remoteFeatures",t=>{this.remoteFeatures=t})),window.addEventListener("resize",this.forceUpdate)}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.timeout),window.removeEventListener("resize",this.forceUpdate)}render(){return this.onRenderProxy(),r.qy`${this.platformTemplate()}`}platformTemplate(){return p.w.isMobile()?r.qy`${this.mobileTemplate()}`:r.qy`${this.desktopTemplate()}`}desktopTemplate(){return this.loading?r.qy`${this.loadingTemplate()}`:r.qy`${this.qrTemplate()}`}qrTemplate(){return r.qy` <wui-flex
    ...
    </wui-flex>`}loaderTemplate(){const t=R.W.state.themeVariables["--w3m-border-radius-master"],e=t?parseInt(t.replace("px",""),10):4;return r.qy`<wui-loading-thumbnail radius=${9*e}></wui-loading-thumbnail>`}async connectFarcaster(){if(this.authConnector)try{await(this.authConnector?.provider.connectFarcaster()),this.socialProvider&&(S.i.setConnectedSocialProvider(this.socialProvider),$.E.sendEvent({type:"track",event:"SOCIAL_LOGIN_REQUEST_USER_DATA",properties:{provider:this.socialProvider}})),this.loading=!0;const t=k.x.getConnections(this.authConnector.chain).length>0;await k.x.connectExternal(this.authConnector,this.authConnector.chain);const e=this.remoteFeatures?.multiWallet;this.socialProvider&&$.E.sendEvent({type:"track",event:"SOCIAL_LOGIN_SUCCESS",properties:{provider:this.socialProvider,caipNetworkId:E.W.getActiveCaipNetwork()?.caipNetworkId}}),this.loading=!1,t&&e?(u.I.replace("ProfileWallets"),P.P.showSuccess("New Wallet Added")):M.W.close()}catch(t){this.socialProvider&&$.E.sendEvent({type:"track",event:"SOCIAL_LOGIN_ERROR",properties:{provider:this.socialProvider}}),u.I.goBack(),P.P.showError(t)}}mobileLinkTemplate(){return r.qy`<wui-button
      size="md"
    ...
    >`}onRenderProxy(){!this.ready&&this.uri&&(this.timeout=setTimeout(()=>{this.ready=!0},200))}qrCodeTemplate(){if(!this.uri||!this.ready)return null;const t=this.getBoundingClientRect().width-40;return r.qy` <wui-qr-code
      ...
      color=${(0,n.J)(R.W.state.themeVariables["--w3m-qr-color"])}
...
`;var u=function(t,e,o,r){var i,n=arguments.length,a=n<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,o,r);else for(var s=t.length-1;s>=0;s--)(i=t[s])&&(a=(n<3?i(a):n>3?i(e,o,a):i(e,o))||a);return n>3&&a&&Object.defineProperty(e,o,a),a};const d={add:async()=>(await o.e(5619).then(o.bind(o,95619))).addSvg,allWallets:async()=>(await o.e(9452).then(o.bind(o,99452))).allWalletsSvg,arrowBottomCircle:async()=>(await o.e(5374).then(o.bind(o,45374))).arrowBottomCircleSvg,appStore:async()=>(await o.e(3019).then(o.bind(o,33019))).appStoreSvg,apple:async()=>(await o.e(8852).then(o.bind(o,58852))).appleSvg,arrowBottom:async()=>(await o.e(3097).then(o.bind(o,33097))).arrowBottomSvg,arrowLeft:async()=>(await o.e(9275).then(o.bind(o,89275))).arrowLeftSvg,arrowRight:async()=>(await o.e(1282).then(o.bind(o,61282))).arrowRightSvg,arrowTop:async()=>(await o.e(1967).then(o.bind(o,31967))).arrowTopSvg,bank:async()=>(await o.e(2236).then(o.bind(o,72236))).bankSvg,browser:async()=>(await o.e(6524).then(o.bind(o,76524))).browserSvg,bin:async()=>(await o.e(4249).then(o.bind(o,64249))).binSvg,bitcoin:async()=>(await o.e(4286).then(o.bind(o,94286))).bitcoinSvg,card:async()=>(await o.e(3524).then(o.bind(o,93524))).cardSvg,checkmark:async()=>(await o.e(525).then(o.bind(o,90525))).checkmarkSvg,checkmarkBold:async()=>(await o.e(8905).then(o.bind(o,48905))).checkmarkBoldSvg,chevronBottom:async()=>(await o.e(4231).then(o.bind(o,44231))).chevronBottomSvg,chevronLeft:async()=>(await o.e(5329).then(o.bind(o,65329))).chevronLeftSvg,chevronRight:async()=>(await o.e(1176).then(o.bind(o,61176))).chevronRightSvg,chevronTop:async()=>(await o.e(3745).then(o.bind(o,3745))).chevronTopSvg,chromeStore:async()=>(await o.e(9208).then(o.bind(o,59208))).chromeStoreSvg,clock:async()=>(await o.e(614).then(o.bind(o,20614))).clockSvg,close:async()=>(await o.e(3176).then(o.bind(o,3176))).closeSvg,compass:async()=>(await o.e(4484).then(o.bind(o,94484))).compassSvg,coinPlaceholder:async()=>(await o.e(410).then(o.bind(o,20410))).coinPlaceholderSvg,copy:async()=>(await o.e(355).then(o.bind(o,70355))).copySvg,cursor:async()=>(await o.e(988).then(o.bind(o,40988))).cursorSvg,cursorTransparent:async()=>(await o.e(4855).then(o.bind(o,84855))).cursorTransparentSvg,circle:async()=>(await o.e(8178).then(o.bind(o,78178))).circleSvg,desktop:async()=>(await o.e(4208).then(o.bind(o,54208))).desktopSvg,disconnect:async()=>(await o.e(9728).then(o.bind(o,99728))).disconnectSvg,discord:async()=>(await o.e(4172).then(o.bind(o,64172))).discordSvg,ethereum:async()=>(await o.e(6351).then(o.bind(o,96351))).ethereumSvg,etherscan:async()=>(await o.e(1461).then(o.bind(o,81461))).etherscanSvg,extension:async()=>(await o.e(7381).then(o.bind(o,67381))).extensionSvg,externalLink:async()=>(await o.e(7274).then(o.bind(o,47274))).externalLinkSvg,facebook:async()=>(await o.e(4698).then(o.bind(o,4698))).facebookSvg,farcaster:async()=>(await o.e(5505).then(o.bind(o,5505))).farcasterSvg,filters:async()=>(await o.e(8075).then(o.bind(o,48075))).filtersSvg,github:async()=>(await o.e(8573).then(o.bind(o,48573))).githubSvg,google:async()=>(await o.e(9521).then(o.bind(o,39521))).googleSvg,helpCircle:async()=>(await o.e(7842).then(o.bind(o,97842))).helpCircleSvg,image:async()=>(await o.e(4541).then(o.bind(o,64541))).imageSvg,id:async()=>(await o.e(8743).then(o.bind(o,18743))).idSvg,infoCircle:async()=>(await o.e(2907).then(o.bind(o,42907))).infoCircleSvg,lightbulb:async()=>(await o.e(7547).then(o.bind(o,57547))).lightbulbSvg,mail:async()=>(await o.e(3721).then(o.bind(o,3721))).mailSvg,mobile:async()=>(await o.e(2756).then(o.bind(o,42756))).mobileSvg,more:async()=>(await o.e(8023).then(o.bind(o,28023))).moreSvg,networkPlaceholder:async()=>(await o.e(2134).then(o.bind(o,72134))).networkPlaceholderSvg,nftPlaceholder:async()=>(await o.e(8679).then(o.bind(o,38679))).nftPlaceholderSvg,off:async()=>(await o.e(413).then(o.bind(o,10413))).offSvg,playStore:async()=>(await o.e(376).then(o.bind(o,80376))).playStoreSvg,plus:async()=>(await o.e(7142).then(o.bind(o,87142))).plusSvg,qrCode:async()=>(await o.e(4195).then(o.bind(o,44195))).qrCodeIcon,recycleHorizontal:async()=>(await o.e(8942).then(o.bind(o,28942))).recycleHorizontalSvg,refresh:async()=>(await o.e(8795).then(o.bind(o,88795))).refreshSvg,search:async()=>(await o.e(6202).then(o.bind(o,6202))).searchSvg,send:async()=>(await o.e(196).then(o.bind(o,60196))).sendSvg,swapHorizontal:async()=>(await o.e(1429).then(o.bind(o,31429))).swapHorizontalSvg,swapHorizontalMedium:async()=>(await o.e(5634).then(o.bind(o,15634))).swapHorizontalMediumSvg,swapHorizontalBold:async()=>(await o.e(638).then(o.bind(o,20638))).swapHorizontalBoldSvg,swapHorizontalRoundedBold:async()=>(await o.e(1259).then(o.bind(o,91259))).swapHorizontalRoundedBoldSvg,swapVertical:async()=>(await o.e(2051).then(o.bind(o,82051))).swapVerticalSvg,solana:async()=>(await o.e(2178).then(o.bind(o,12178))).solanaSvg,telegram:async()=>(await o.e(7137).then(o.bind(o,57137))).telegramSvg,threeDots:async()=>(await o.e(8617).then(o.bind(o,38617))).threeDotsSvg,twitch:async()=>(await o.e(9605).then(o.bind(o,59605))).twitchSvg,twitter:async()=>(await o.e(7420).then(o.bind(o,57420))).xSvg,twitterIcon:async()=>(await o.e(5622).then(o.bind(o,5622))).twitterIconSvg,user:async()=>(await o.e(9653).then(o.bind(o,29653))).userSvg,verify:async()=>(await o.e(6963).then(o.bind(o,86963))).verifySvg,verifyFilled:async()=>(await o.e(4368).then(o.bind(o,94368))).verifyFilledSvg,wallet:async()=>(await o.e(8235).then(o.bind(o,88235))).walletSvg,walletConnect:async()=>(await o.e(3565).then(o.bind(o,33565))).walletConnectSvg,walletConnectLightBrown:async()=>(await o.e(3565).then(o.bind(o,33565))).walletConnectLightBrownSvg,walletConnectBrown:async()=>(await o.e(3565).then(o.bind(o,33565))).walletConnectBrownSvg,walletPlaceholder:async()=>(await o.e(8447).then(o.bind(o,78447))).walletPlaceholderSvg,warningCircle:async()=>(await o.e(7873).then(o.bind(o,37873))).warningCircleSvg,x:async()=>(await o.e(7420).then(o.bind(o,57420))).xSvg,info:async()=>(await o.e(4734).then(o.bind(o,54734))).infoSvg,exclamationTriangle:async()=>(await o.e(7106).then(o.bind(o,7106))).exclamationTriangleSvg,reown:async()=>(await o.e(7391).then(o.bind(o,97391))).reownSvg,"x-mark":async()=>(await o.e(8940).then(o.bind(o,68940))).xMarkSvg};let h=class extends r.WF{constructor(){super(...arguments),this.size="md",this.name="copy",this.color="fg-300",this.aspectRatio="1 / 1"}render(){return this.style.cssText=`\n      --local-color: var(--wui-color-${this.color});\n      --local-width: var(--wui-icon-size-${this.size});\n      --local-aspect-ratio: ${this.aspectRatio}\n    `,r.qy`${(0,n.T)(async function(t){if(a.has(t))return a.get(t);const e=(d[t]??d.copy)();return a.set(t,e),e}(this.name),r.qy`<div class="fallback"></div>`)}`}};h.styles=[s.W5,s.ck,l],u([(0,i.MZ)()],h.prototype,"size",void 0),u([(0,i.MZ)()],h.prototype,"name",void 0),u([(0,i.MZ)()],h.prototype,"color",void 0),u([(0,i.MZ)()],h.prototype,"aspectRatio",void 0),h=u([(0,c.E)("wui-icon")],h)},82890:(t,e)=>{let o;const r=[0,26,44,70,100,134,172,196,242,292,346,404,466,532,581,655,733,815,901,991,1085,1156,1258,1364,1474,1588,1706,1828,1921,2051,2185,2323,2465,2611,2761,2876,3034,3196,3362,3532,3706];e.getSymbolSize=function(t){if(!t)throw new Error('"version" cannot be null or undefined');if(t<1||t>40)throw new Error('"version" should be in range from 1 to 40');return 4*t+17},e.getSymbolTotalCodewords=function(t){return r[t]},e.getBCHDigit=function(t){let e=0;for(;0!==t;)e++,t>>>=1;return e},e.setToSJISFunction=function(t){if("function"!=typeof t)throw new Error('"toSJISFunc" is not a valid function.');o=t},e.isKanjiModeEnabled=function(){return void 0!==o},e.toSJIS=function(t){return o(t)}},83036:(t,e,o)=>{"use strict";var r=o(48422),i=o(91427),n=(o(77200),o(17262),o(94083));function a(t,e,o){return t!==e&&(t-e<0?e-t:t-e)<=o+.1}const s={generate({uri:t,size:e,logoSize:o,dotColor:i="#141414"}){const s=[],c=function(t){const e=Array.prototype.slice.call(n.create(t,{errorCorrectionLevel:"Q"}).modules.data,0),o=Math.sqrt(e.length);return e.reduce((t,e,r)=>(r%o===0?t.push([e]):t[t.length-1].push(e))&&t,[])}(t),l=e/c.length,u=[{x:0,y:0},{x:1,y:0},{x:0,y:1}];u.forEach(({x:t,y:e})=>{const o=(c.length-7)*l*t,n=(c.length-7)*l*e,a=.45;for(let t=0;t<u.length;t+=1){const e=l*(7-2*t);s.push(r.JW`
          ...
          `)}});const d=Math.floor((o+25)/l),h=c.length/2-d/2,g=c.length/2+d/2-1,p=[];c.forEach((t,e)=>{t.forEach((t,o)=>{if(c[e][o]&&!(e<7&&o<7||e>c.length-8&&o<7||e<7&&o>c.length-8||e>h&&e<g&&o>h&&o<g)){const t=e*l+l/2,r=o*l+l/2;p.push([t,r])}})});const f={};return p.forEach(([t,e])=>{f[t]?f[t]?.push(e):f[t]=[e]}),Object.entries(f).map(([t,e])=>{const o=e.filter(t=>e.every(e=>!a(t,e,l)));return[Number(t),o]}).forEach(([t,e])=>{e.forEach(e=>{s.push(r.JW`<circle cx=${t} cy=${e} fill=${i} r=${l/2.5} />`)})}),Object.entries(f).filter(([t,e])=>e.length>1).map(([t,e])=>{const o=e.filter(t=>e.some(e=>a(t,e,l)));return[Number(t),o]}).map(([t,e])=>{e.sort((t,e)=>t<e?-1:1);const o=[];for(const t of e){const e=o.find(e=>e.some(e=>a(t,e,l)));e?e.push(t):o.push([t])}return[t,o.map(t=>[t[0],t[t.length-1]])]}).forEach(([t,e])=>{e.forEach(([e,o])=>{s.push(r.JW`
              <line
                ...
                stroke-linecap="round"
              />
            `)})}),s}};var c=o(47080),l=o(39783);const u=r.AH`
  :host {
    position: relative;
    user-select: none;
    display: block;
...
`;var d=function(t,e,o,r){var i,n=arguments.length,a=n<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(t,e,o,r);else for(var s=t.length-1;s>=0;s--)(i=t[s])&&(a=(n<3?i(a):n>3?i(e,o,a):i(e,o))||a);return n>3&&a&&Object.defineProperty(e,o,a),a};let h=class extends r.WF{constructor(){super(...arguments),this.uri="",this.size=0,this.theme="dark",this.imageSrc=void 0,this.alt=void 0,this.arenaClear=void 0,this.farcaster=void 0}render(){return this.dataset.theme=this.theme,this.dataset.clear=String(this.arenaClear),this.style.cssText=`\n     --local-size: ${this.size}px;\n     --local-icon-color: ${this.color??"#3396ff"}\n    `,r.qy`${this.templateVisual()} ${this.templateSvg()}`}templateSvg(){const t="light"===this.theme?this.size:this.size-32;return r.JW`
    ...
    `}templateVisual(){return this.imageSrc?r.qy`<wui-image src=${this.imageSrc} alt=${this.alt??"logo"}></wui-image>`:this.farcaster?r.qy`<wui-icon
        ...
        color="inherit"
        name="farcaster"
      ></wui-icon>`:r.qy`<wui-icon size="inherit" color="inherit" name="walletConnect"></wui-icon>`}};h.styles=[c.W5,u],d([(0,i.MZ)()],h.prototype,"uri",void 0),d([(0,i.MZ)({type:Number})],h.prototype,"size",void 0),d([(0,i.MZ)()],h.prototype,"theme",void 0),d([(0,i.MZ)()],h.prototype,"imageSrc",void 0),d([(0,i.MZ)()],h.prototype,"alt",void 0),d([(0,i.MZ)()],h.prototype,"color",void 0),d([(0,i.MZ)({type:Boolean})],h.prototype,"arenaClear",void 0),d([(0,i.MZ)({type:Boolean})],h.prototype,"farcaster",void 0),h=d([(0,l.E)("wui-qr-code")],h)},88766:(t,e,o)=>{"use strict";var r=o(48422),i=(o(77200),o(36858),o(46116),o(35016)),n=o(47080),a=o(39783);const s=r.AH`
  .reown-logo {
