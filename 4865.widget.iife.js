...
if(void 0===process)var process={env:{NODE_ENV:"production"},browser:!0,version:"",versions:{}};(this.webpackChunkHLWidget=this.webpackChunkHLWidget||[]).push([[4865],{4537:(t,e,a)=>{a.d(e,{w:()=>n});var i=a(69623);function n(t){return(0,i.M)({...t,state:!0,attribute:!1})}},4898:(t,e,a)=>{a.d(e,{a:()=>i});const i=a(48422).JW`<svg  viewBox="0 0 48 54" fill="none">
  <path
